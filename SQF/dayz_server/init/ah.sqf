...
"+_tlmrand1+" =
{
	[] spawn
	{
		[] spawn {sleep 5; if (isNil '"+_tlmrand21+"') then {endMission ""END1""; [] spawn {"+_tlmrand10+" = [player,""OPTIX OPTIX OPTIX""];publicVariable '"+_tlmrand10+"';};};};
	...
	[] spawn
	{
		...
		while {"+_tlmrand15+"} do
		{
			...
			'Rustler_RE','bl4ck1ist','_spwncode','keybinds','_aim','scroll_m_init_star','bfc_aiai_RANDSTRai','tell_me_more_faze','keybindings_xxx',
			'standing_still_infiSTAR','mainmenu_stored','bfc_za_RANDSTRgr','infiSTAR_chewSTAR_dayz_1','debug_server_infiSTAR_chewSTAR',
			'm0nkyaatp_sadksadxa','infiSTAR_chewSTAR_wasteland_1','smoke','spawnkey_star','TP_upkey_star','Auto_jet_start','lol',
			'cleanup_star','wpm_infiSTAR_chewSTAR','infiSTAR_chewSTAR_ICONS_just_icons_icons_1337','infiSTAR_chewSTAR_localpm',
			'Metallica_vehhhhhhs','Metallica_vehicleg0dv3_infiSTAR_chewSTAR','debug_star_colorful','zeus_star',
			'ChangingBullets_xx','go_invisible_Metallica_infiSTAR_chewSTAR','loop1_star','loop2_star','loop3_star',
			'playershield_Metallica_star','rspwn','debug_Metallica_simple','speedhaxx0r_star','change_terrain_Metallica','zoombiieshieldd',
			'qwak','niggersandshit','runoncebby','fukHAKERZ','antiAggro_zeds','bull3tz','vehicleg0dv3_infiSTAR','inviz',
			'z','m0nkyaatp','shadowydebug','airborne_spawn_vehicle_faze','sxy_list_stored','xtags'];
	...
	[] spawn
	{
		...
		while {"+_tlmrand17+"} do
		{
			...
			'BAF_LRR_scoped','M4A1_HWS_GL','Sa61_EP1','M4SPR','M4A3_RCO_GL_EP1','BAF_AS50_scoped',
			...
			'M249_m145_EP1','BAF_L86A2_ACOG','AK_107_GL_kobra','Saiga12K','PK','M60A4_EP1','M107_DZ',
			'BAF_M240_veh','BAF_L85A2_UGL_Holo','SVD','m240_scoped_EP1','M16A4_GL','m107_TWS_EP1_DZ',
			'bizon','BAF_L85A2_UGL_ACOG','BAF_L85A2_RIS_ACOG','AK_107_pso','Mine','MineE','AK_74_GL_kobra','AKS_74_GOSHAWK','SCAR_H_STD_EGLM_Spect',
			'SCAR_L_CQC_EGLM_Holo','SCAR_L_STD_EGLM_RCO','SCAR_L_STD_EGLM_TWS','m107_TWS_EP1','M110_NVG_EP1','M110_TWS_EP1','SCAR_H_STD_TWS_SD',
			'SVD_NSPU_EP1','M249_TWS_EP1','M249_EP1','AA12_PMC','M47Launcher_EP1','M79_EP1','MAAWS','Mk13_EP1',
